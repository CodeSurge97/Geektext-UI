                ...
                <div className="row">
                    ...
                    {(this.state.library) ? this.state.library.map(book => (
                            <div className="col-md-12 d-flex justify-content-between" style={{padding: "5px"}} key={book.isbn}>
                                <Book genre={book.genre} rating={book.rating} isbn={book.isbn} title={book.title} author={book.author} price={book.price} image={book.img} description={book.description} callbackFromParent={this.myCallback}/>
                            </div>
                    )) : null}
                </div>
